...
export const Tools = ({}: ToolsProps) => {
  ...
  const [
    ...
    sectionBrushConfigurationCollapsed,
  ] = useState(false);
  ...
  return (
    <aside id="tools">
      <div className="tools-section">
        ...
        {section_brush_configuration_collapsed ? (
          ...
          <div className="section-content">
            <fieldset>
              <label htmlFor="colors">Brush Color</label>
              <div>
                <input
                  type="color"
                  name="primary"
            ...
            <fieldset>
              <label htmlFor="type">Brush Shape</label>
              <select
                name="type"
                id="type"
                onChange={(event) => {
            ...
            <fieldset>
              <label htmlFor="size">Brush Size {brushData.width}</label>
              <input
                type="range"
                name="size"
                id="size"
            ...
            <fieldset>
              <label htmlFor="opacity">Brush Opacity {brushData.opacity}</label>
              <input
                type="range"
                name="opacity"
                id="opacity"
            ...
            <fieldset>
              <label htmlFor="operation">Draw Operation</label>
              <select
                name="operation"
                id="operation"
                onChange={(event) => {
      ...
      <div className="tools-section">
        <div
          className="section-label"
          onClick={() => setSectionOtherCollapsed(!section_other_collapsed)}
        >
          Other
        </div>
        {section_other_collapsed ? (
          ...
          <div className="section-content">
            <fieldset>
              <label htmlFor="zoom">Zoom Level {zoom_level}%</label>
              <input
                type="range"
                name="zoom"
                id="zoom"
